...
def index(request):
    ...
    num_books = Book.objects.all().filter(title__contains="Biology").count()
...
class BookListView(generic.ListView):
    ...
    #queryset = Book.objects.filter(title__icontains='Bio')[:5] # Get 5 books containing the title war
